...
folder_path <- "/home/h/hw309/projects/Research/TCR and Gene Expression/PC distance analysis/GSE145926/untar"

# get a list of all files in the folder

file_list <- list.files(folder_path)
file_matrix = file_list[endsWith(file_list, "_matrix.h5")]
...
for (i in seq_along(file_matrix)) {
  ...
  seurat.data <- Read10X_h5(filename = file.path(folder_path, file_matrix[i]))
  saveRDS(seurat.data, paste0("/home/h/hw309/projects/Research/TCR and Gene Expression/PC distance analysis/GSE145926/matrix/", sample[i], ".rds"))
  remove(seurat.data)
  gc()
  print("done")
}
...
for (i in seq_along(file_matrix)) {
  ...
  # Load the PBMC dataset
  pbmc.data <- Read10X_h5(filename = file.path(folder_path, file_matrix[i]))
...
saveRDS(df_immu, file = "/home/h/hw309/projects/Research/TCR and Gene Expression/PC distance analysis/GSE145926/df_immu_imputed.rds")
