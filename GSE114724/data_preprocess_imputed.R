...
folder_path <- "/home/h/hw309/projects/Research/TCR and Gene Expression/PC distance analysis/GSE114724/untar"
...
for (i in seq_along(file_matrix)) {
  ...
  saveRDS(seurat.data, paste0("/home/h/hw309/projects/Research/TCR and Gene Expression/PC distance analysis/GSE114724/matrix/", sample[i], ".rds"))
  remove(seurat.data)
  gc()
  print("done")
}
...
saveRDS(df_immu, file = "/home/h/hw309/projects/Research/TCR and Gene Expression/PC distance analysis/GSE114724/df_immu_imputed.rds")
