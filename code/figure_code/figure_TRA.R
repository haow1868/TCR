...
# between clones
median_distance_two_clones_CD4_file = paste0(folder_path, "/", file_GSE, "/output_CD4/median_distance_two_clones_CD4_TRA.rds")
median_distance_two_clones_CD4 = median_distance_two_clones_CD4_file %>% map_dfr(readRDS)
median_distance_two_clones_CD8_file = paste0(folder_path, "/", file_GSE, "/output_CD8/median_distance_two_clones_CD8_TRA.rds")
median_distance_two_clones_CD8 = median_distance_two_clones_CD8_file %>% map_dfr(readRDS)

sample_median_CD4_file = paste0(folder_path, "/", file_GSE, "/output_CD4/sample_median_TRA.rds")
sample_median_CD8_file = paste0(folder_path, "/", file_GSE, "/output_CD8/sample_median_TRA.rds")
sample_median_CD4 = 
...
Ran_sample_median_CD4_file = paste0(folder_path, "/", file_GSE, "/output_CD4/Ran_sample_median_TRA.rds")
Ran_sample_median_CD8_file = paste0(folder_path, "/", file_GSE, "/output_CD8/Ran_sample_median_TRA.rds")
...
# supp2
pdf(paste0(folder_path, "/plots_paper/figure1_TRA/trend.pdf"), width = 14, height = 12)
...
library(ggsignif)
# new
pdf(paste0(folder_path, "/plots_paper/figure1_TRA/figure1d.pdf"), width = 6.5, height =4.7)
