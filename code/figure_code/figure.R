...
# figure 1b
sub_num_perm_TRA = readRDS(paste0(folder_path, "/data_allStudy/sub_num_perm_TRA.rds")) %>%
  mutate(clone_type = "TRA")
sub_num_perm_TRB = readRDS(paste0(folder_path, "/data_allStudy/sub_num_perm_TRB.rds")) %>%
  mutate(clone_type = "TRB")

sub_num_est_TRA = readRDS(paste0(folder_path, "/data_allStudy/sub_num_TRA.rds")) %>%
  mutate(clone_type = "TRA")
sub_num_est_TRB = readRDS(paste0(folder_path, "/data_allStudy/sub_num_TRB.rds")) %>%
  mutate(clone_type = "TRB")

sub_num = rbind(sub_num_perm_TRA, sub_num_est_TRA,
                sub_num_perm_TRB, sub_num_est_TRB)
...
distance_full_CD4_file = paste0(folder_path, "/", file_GSE, "/output_CD4/TRA/distance_full.rds")
distance_full_CD8_file = paste0(folder_path, "/", file_GSE, "/output_CD8/TRA/distance_full.rds")
permuted_df_disease_TRA = figure1c_df(distance_full_CD4_file, distance_full_CD8_file, "TRA")

distance_full_CD4_file = paste0(folder_path, "/", file_GSE, "/output_CD4/TRB/distance_full.rds")
distance_full_CD8_file = paste0(folder_path, "/", file_GSE, "/output_CD8/TRB/distance_full.rds")
permuted_df_disease_TRB = figure1c_df(distance_full_CD4_file, distance_full_CD8_file, "TRB")

distance_full_CD4_file = paste0(folder_path, "/", file_GSE, "/output_CD4/TRA+TRB/distance_full.rds")
distance_full_CD8_file = paste0(folder_path, "/", file_GSE, "/output_CD8/TRA+TRB/distance_full.rds")
...
bet_clones_df = function(clone_type){
  med_dist_bet_clones_CD4 = paste0(folder_path, "/", file_GSE, "/output_CD4/", clone_type, "/med_dist_bet_clones.rds") %>% map_dfr(readRDS)
  med_dist_bet_clones_CD8 = paste0(folder_path, "/", file_GSE, "/output_CD8/", clone_type, "/med_dist_bet_clones.rds") %>% map_dfr(readRDS)
  
  sample_median_CD4_file = paste0(folder_path, "/", file_GSE, "/output_CD4/", clone_type, "/sample_median.rds")
  sample_median_CD8_file = paste0(folder_path, "/", file_GSE, "/output_CD8/", clone_type, "/sample_median.rds")
  sample_median_CD4 = 
  ...
  Ran_sample_median_CD4_file = paste0(folder_path, "/", file_GSE, "/output_CD4/", clone_type, "/Ran_sample_median.rds")
  Ran_sample_median_CD8_file = paste0(folder_path, "/", file_GSE, "/output_CD8/", clone_type, "/Ran_sample_median.rds")
...
Supp_table1 = df_immu_all %>%
  select(sample, GEO, gender, tissue, disease, GEO) %>%
  distinct()
