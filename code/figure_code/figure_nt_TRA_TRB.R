...
# between clones
median_distance_two_clones_CD4_file = paste0(folder_path, "/", file_GSE, "/DNA/output_CD4/median_distance_two_clones_CD4_TRA_TRB.rds")
median_distance_two_clones_CD4 = median_distance_two_clones_CD4_file %>% map_dfr(readRDS)
median_distance_two_clones_CD8_file = paste0(folder_path, "/", file_GSE, "/DNA/output_CD8/median_distance_two_clones_CD8_TRA_TRB.rds")
median_distance_two_clones_CD8 = median_distance_two_clones_CD8_file %>% map_dfr(readRDS)

sample_median_CD4_file = paste0(folder_path, "/", file_GSE, "/DNA/output_CD4/sample_median_TRA_TRB.rds")
sample_median_CD8_file = paste0(folder_path, "/", file_GSE, "/DNA/output_CD8/sample_median_TRA_TRB.rds")
sample_median_CD4 = 
...
Ran_sample_median_CD4_file = paste0(folder_path, "/", file_GSE, "/DNA/output_CD4/Ran_sample_median_TRA_TRB.rds")
Ran_sample_median_CD8_file = paste0(folder_path, "/", file_GSE, "/DNA/output_CD8/Ran_sample_median_TRA_TRB.rds")
...
# supp2
pdf(paste0(folder_path, "/plots_paper/figure1_nt_TRA_TRB/trend.pdf"), width = 25, height = 20)
ggplot(data = sample_median %>% filter(distance_TRA_TRB <= 30)) +
...
library(ggsignif)
# new
pdf(paste0(folder_path, "/plots_paper/figure1_nt_TRA_TRB/figure1d.pdf"), width = 12, height =4.7)
ggplot(data = trend_df %>% filter(distance_TRA_TRB <= 30)) +
